...
public class ServerAutoConfiguration {
    ...
    public AbstractDeviceManager deviceManager(ServerProperties properties) {
        return new LocalDeviceManager(properties.getTimeout());
    }

    @Bean
    @ConditionalOnMissingBean(AbstractTokenManager.class)
    public AbstractTokenManager tokenManager(ServerProperties properties, AbstractDeviceManager deviceManager) {
        return new LocalTokenManager(properties.getAccessTokenTimeout(), properties.getTimeout(),
                properties.getThreadPoolSize(), deviceManager);
    }
    ...
    public AbstractTicketGrantingTicketManager tgtManager(ServerProperties properties,
        ...
        return new LocalTicketGrantingTicketManager(properties.getTimeout(), properties.getCookieName(),
                tokenManager);
    }
}
